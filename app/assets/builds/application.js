...
%o`, message, error2, detail);
  ...
  var product_items = document.querySelectorAll(".carousel .new-product-carousel");
  ...
  var promo_items = document.querySelectorAll(".carousel .promo-carousel");
  ...
  var items = document.querySelectorAll(".carousel .product-image");
  items.forEach((el) => {
    const minPerSlide = 4;
    let next = el.nextElementSibling;
    for (var i = 1; i < minPerSlide; i++) {
  ...
  var listImageArea = carouselContainer.querySelector(".carousel-inner");
  var listOfImages = listImageArea.querySelectorAll("img");
  var currentImage = carouselContainer.querySelector(".current-image");
